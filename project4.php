...
<head>
    ...
    <title>Project Website - Rahmat Ramadhan</title>
...
<body>
    ...
    <section class="project-hero">
        <h1 class="project-title">Website</h1>
        <p class="project-subtitle">Website yang menampilkan tentang Pulau Penyengat</p>
        
        <div class="project-mockup">
            <img src="./img/project-4.png" alt="Branding Mockup">
        </div>
    </section>
        ...
        <div class="details-container">
            <div class="project-info">
                <div class="project-description">
                    ...
                    <p>Situs web ini di buat untuk melihatkan kepada semua orang tentang pulau bersejarah ini yaitu Pulau Penyengat.</p>
                    <p>Situs web ini juga di buat karena banyak orang bekum tau tantang pulau penyengat dan apa saja yang ada di pulau ini.</p>
                </div>
            </div>
            ...
            <div class="project-stats">
                <div class="stat-item">
                    ...
                    <div class="stat-value">2 Bulan</div>
                </div>
            
                <div class="stat-item">
                    <div class="stat-label">Variasi Logo</div>
                    <div class="stat-value">15+</div>
                </div>
                
                <div class="stat-item">
                    <div class="stat-label">Palet Warna</div>
                    <div class="stat-value">3 Lengkap</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        // Additional interactivity for project page
