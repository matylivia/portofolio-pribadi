...
<body>
    ...
    <section class="project-hero">
        ...
        <p class="project-subtitle">Situs web pemesanan alat pancing</p>
        
        <div class="project-mockup">
            <img src="./img/project-2.png" alt="Mockup Website">
        </div>
    </section>
        ...
        <div class="details-container">
            <div class="project-info">
                <div class="project-description">
                    ...
                    <p>Situs web pemesanan alat pancing ini di buat agar dapat memesan alat pancing tanpa harus ke tokonya langsung.</p>
                    <p>Situs web ini menapilkan beragam alat pancing yang menarik dengan kulitas yang bagus.</p>
                </div>
            </div>
            ...
            <div class="project-stats">
                ...
                <div class="stat-item">
                    ...
                    <div class="stat-value">iOS, Android & laptop</div>
                </div>
