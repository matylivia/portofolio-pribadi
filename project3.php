...
<body>
    ...
    <section class="project-hero">
        ...
        <p class="project-subtitle">Website pemesanan kamar hotel dengan kualitas yang sangat bagus.</p>
        
        <div class="project-mockup">
            <img src="./img/project-3.png" alt="Dashboard Mockup">
        </div>
    </section>
        ...
        <div class="details-container">
            <div class="project-info">
                <div class="project-description">
                    ...
                    <p>Situs web ini di rancang untuk melakukan pemesanan kamar hotel dengan kualitas yang bagus dan juga pemesanan yang mulus.</p>
                    <p>Situs web ini di buat dengan desain yang memanjakan mata dengan warna yang enak untuk di pandang.</p>
                </div>
            </div>
            ...
            <div class="project-stats">
                <div class="stat-item">
                    ...
                    <div class="stat-value">3 Bulan</div>
                </div>
